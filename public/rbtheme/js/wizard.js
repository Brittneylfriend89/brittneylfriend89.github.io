...
var wizardInit = function wizardInit() {
    ...
    wizards.forEach(function (wizard) {
        ...
        var phonePattern = inputPhone.getAttribute('pattern');
        ...
        nextButton.addEventListener('click', function () {
            if (count == 0) {
                if (!selectService.options[selectService.options.selectedIndex].value || !selectEmployee.options[selectEmployee.options.selectedIndex].value || !selectDate.value) {
