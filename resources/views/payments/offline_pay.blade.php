                                        ...
                                        <form method="POST" action="{{ route('pay',$payment->id.'?frm=detail') }}" id="account-info" autocomplete="off">
                                            ...
                                            <div class="card-body p-0">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control custom-control custom-format flicker" name="payment_date"  value="{{ $payment->payment_date }}" autocomplete="off" 
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="amount"  value="{{ $payment->amount }}" id="amount" placeholder="{{ __('Enter Amount') }}"  autocomplete="off">
                                                    </div>
                                                </div>
                                        ...
                                        <form method="POST" action="{{ route('pay',$payment->id.'?frm=cash') }}" id="cash-frm" autocomplete="off">
                                            ...
                                            <div class="card-body pb-2 mt-0 p-0">
                                               ...
                                               {{ __(' Cash Details') }}
                                                ...
                                                <div class="mb-3">
                                                    <label for="date" class="form-label">{{ __('Date') }}:</label>
                                                    <input type="text" class="form-control custom-control flicker custom-format border-right-0 border-left-0" name="payment_date"  value="{{ $payment->payment_date }}" autocomplete="off" 
                                                    data-wizard-validate-date="true"  data-date-format="{{ $custom->date_format }}" placeholder="{{ __('Please Select Date') }}">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="amount" class="form-label">{{ __('Amount') }}:</label>
