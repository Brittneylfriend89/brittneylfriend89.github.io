              ...
              <div class="card mb-3 ">
                ...
                <div class="card-body bg-light">
                  ...
                  @method('PATCH')
                    ...
                    <div class="col-12 d-flex justify-content-end mt-3"><button class="btn btn-primary" type="submit">{{ __('Update') }}</button></div>
                  </form>
                </div>
              </div>
            </div>
                    ...
                    @csrf
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          ...
                          <span toggle="old-password" class="toggle-password open"><i class="fa fa-eye-slash"></i></span>
                          <span toggle="old-password" class="toggle-password close d-none"><i class="fa fa-eye"></i></span>
                          <input class="form-control" name="old_password" placeholder="{{ __('Current Password') }}" id="old-password" type="password" />
                      ...
                      <div class="row">
                        <div class="col-md-6">
                            ...
                            <span toggle="new-password" class="toggle-password open"><i class="fa fa-eye-slash"></i></span>
                            <span toggle="new-password" class="toggle-password close d-none"><i class="fa fa-eye"></i></span>
                            <input class="form-control" placeholder="{{ __('New Password') }}" name="new_password" id="new-password" type="password" />
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="confirm-password">{{ __('Confirm Password') }}</label>
                            <span toggle="confirm-password" class="toggle-password open"><i class="fa fa-eye-slash"></i></span>
                            <span toggle="confirm-password" class="toggle-password close d-none"><i class="fa fa-eye"></i></span>
                            <input class="form-control" placeholder="{{ __('Confirm Password') }}" name="confirm_password" id="confirm-password" type="password" />
                        </div>
