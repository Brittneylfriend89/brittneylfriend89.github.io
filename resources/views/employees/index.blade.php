                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a @if($employee->google_verify == true) {{ 'disabled' }} href="javascript:void(0)" class="remove-google" data-id="{{$employee->id}}" @else href="{{ route('SendEmailGoogleCalenderLink',$employee->id) }}" @endif>
