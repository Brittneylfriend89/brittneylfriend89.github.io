                        ...
                        <div class="container-fluid">
                            <div class="current-page">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group" id="datetimepickerRest2">
                                                        <input type="text" class="form-control custom-control @error('start_time') is-invalid @enderror timeDuration" id="start_time"
                                                            value="{{ date('Y-m-d h:i A',strtotime($workingHour->start_time)) }}" name="start_time" placeholder="HH:mm A">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group" id="datetimepickerRest3">
                                                        ...
                                                        value="{{ date('Y-m-d h:i A',strtotime($workingHour->finish_time)) }}" name="finish_time" placeholder="HH:mm A">
                                                        <span class="input-group-text">
                                                            <span class="glyphicon glyphicon-time"></span>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="mb-3"> 
                                                    ...
                                                    <div class='input-group' id="datetimepickerRest">
                                                        <input type='text' class="form-control @error('rest_time') is-invalid @enderror timeDuration" name="rest_time" value="{{ date('Y-m-d H:i', strtotime($workingHour->rest_time)) }}">
                                                        <span class="input-group-text">
                                                            <span class="glyphicon glyphicon-time"></span>
                                                        </span>
                                                    </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group" id="datetimepickerRest4">
                                                        <input type="text" class="form-control custom-control @error('break_start_time') is-invalid @enderror timeDuration" id="break_start_time"
                                                            value="{{ date('Y-m-d h:i A',strtotime($workingHour->break_start_time)) }}" name="break_start_time" placeholder="HH:mm A">
                                                        <span class="input-group-text">
                                                            <span class="glyphicon glyphicon-time"></span>
                                                        </span>
                                                    </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group" id="datetimepickerRest5">
                                                        <input type="text" class="form-control custom-control @error('break_end_time') is-invalid @enderror timeDuration" id="break_end_time"
                                                            value="{{ date('Y-m-d h:i A',strtotime($workingHour->break_end_time)) }}" name="break_end_time" placeholder="HH:mm A">
                                                        <span class="input-group-text">
                                                            <span class="glyphicon glyphicon-time"></span>
                                                        </span>
                                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <a class="next-button pull-right" id="next-button" style="cursor: pointer;"><h4><i class="fa fa-arrow-right" aria-hidden="true"></i> {{ __('Next') }}</h4></a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="mb-3">
                                                    <label class="form-label customCategory" data-customcategory="{{ $custom->categories }}">{{ __('Categories') }}:</label>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="mb-3" name="service_id" id="service_id">
                                                    <label class="form-label servicesList" data-services='{{ json_encode($employeeServices) }}'>{{ __('Services') }}:</label>
