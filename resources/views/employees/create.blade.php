                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="tel" class="form-control custom-control country-phone-validation intlTelInput @error('phone') is-invalid @enderror" id="phone" value="" placeholder="{{ __('Enter Your Phone Number') }}" name="phone"
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="mb-3">
                                                                ...
                                                                <div class='input-group' id="datetimepickerRest">
                                                                    <input type='text' class="form-control time @error('rest_time') is-invalid @enderror timeDuration" name="rest_time" value="{{old('rest_time')}}"  id="rest_time" placeholder="HH:mm" autocomplete="off">
                                                                    <span class="input-group-text">
                                                                        <span class="glyphicon glyphicon-time"></span>
                                                                    </span>
                                                                </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="mb-3" name="service_id" id="service_id">
                                                            ...
                                                            <li class="list-group-item" required>
                                                                {{ $service->name }}
                                                                <div class="material-switch pull-right">
                                                                    <input value="{{ $service->id }}" name="service_id[{{ $service->category_id }}][]" data-check="service" type="checkbox"  @if(is_array(old('service_id')) && isset(old('service_id')[$service->category_id]) && in_array($service->id ,old('service_id')[$service->category_id])) checked @endif>
