                ...
                <div class="card row-bordered card-setting">
                    <form method="POST" action="{{ route('setting.update',Auth::user()->id) }}" id="custom-frm"
                        ...
                        <img src="{{ asset('img/employee/calendar.png') }}" class="img-right" height="35px"
                            width="40px" alt="{{ __('Google Calender') }}">
                        <hr class="border-light m-0">
                        <div class="mb-3">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card row-bordered card-setting">
                    <form method="POST" action="{{ route('setting.update',Auth::user()->id) }}" id="timeslot-frm"
                        ...
                        <hr class="border-light m-0">
                        <div class="mb-3">
                            <input class="form-check-input" type="radio" name="custom_time_slot" value="1"
                                {{ ($smtp->custom_time_slot == "1")? "checked" : "" }} />
                            <label class="form-check-label" for="bootstrap-wizard-time">
                                {{ __('Add before selection') }}
                            </label>
                        </div>
                        <div class="mb-3">
                            <input class="form-check-input" type="radio" name="custom_time_slot" value="2"
                        ...
                        <div class="mb-3">
                            <input class="form-check-input" type="radio" name="custom_time_slot" value="0"
