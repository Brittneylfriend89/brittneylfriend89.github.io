                    ...
                    <div class="card row-bordered card-setting">
                        <form action="{{ route('sms.notification.update' )}}" method="post" id="notification-frm" autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <div class="save">
                                    <button type="submit" class="btn btn-primary float-right-c btn-valid">{{ __('Update') }}</button>
                                    
                                    <span class="pull-right">
                                        <button type="button" class="btn btn-primary testSms mr-5" data-bs-toggle="modal" data-bs-target="#testSmsModel">
