...
@section('content')
    ...
    <section class="board calendar padding-space-half">
        ...
        <a href="{{ (Auth::user()->role_id == 2) ? route('book_now') : route('appointments.create') }}"><span class="ml-c-30"><button class="btn btn-default custom-btn btn-inline"> {{ __('ADD NEW') }}</button></span></a>
        @endif
