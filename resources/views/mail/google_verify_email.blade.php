                            ...
                            <table style="width:100%;margin:auto;border-bottom:1px solid #ebecf2;padding-bottom:15px">
                                <tbody><tr>
                                    <td style="padding:0">
                                        ...
                                        <div style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;font-size:14px;color:rgba(0,0,0,0.87);line-height:20px;padding-top:20px;text-align:center">Link the calendar with ReadyBook. Please click the button and link your email with Google calendar.</div>
                                    </td>
                                </tr>
                            </tbody></table>
                        </td>
