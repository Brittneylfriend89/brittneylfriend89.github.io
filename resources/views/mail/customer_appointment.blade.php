  ...
  <table style="max-width:670px;margin:50px auto 10px;background-color:#fff;padding:50px;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px;-webkit-box-shadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.24);-moz-box-shadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.24);box-shadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.24); border-top: solid 10px green;">
    <thead>
      <tr>
        @env('local')
          @if(empty($site->logo))
          <th style="text-align:left;"><img style="max-width: 150px;" src="https://readybook.zluck.in/rbtheme/img/default-logo.png" alt="{{ __('zluck')}}"></th>
          @else
          <th style="text-align:left;"><img style="max-width: 150px;" src="https://readybook.zluck.in/rbtheme/img/default-logo.png" alt="{{ __('zluck')}}"></th>
          @endif
        @else
          @if(empty($site->logo))
          <th style="text-align:left;"><img style="max-width: 150px;" src="{{ asset('rbtheme/img/logo.png' )}}" alt="{{ __('zluck')}}"></th>
          @else
          <th style="text-align:left;"><img style="max-width: 150px;" src="{{ asset('img/logo/'.$site->logo )}}" alt="{{ __('zluck')}}"></th>
          @endif
        @endenv
    ...
    <tfooter>
      ...
      <tr>
        <td colspan="2" style="font-size:14px;padding:10px 15px 0 15px;">
          ...
          <b>{{ __('Phone')}}:</b> +91 97262 50544<br>
        </td>
      </tr>
      <tr>
