                            ...
                            <table style="width:100%;margin:auto;padding-bottom:15px">
                                ...
                                <td style="padding:15px 0 0 0">
                                        <table style="width:100%;margin:auto;max-width:250px">
                                            <tbody><tr>
                                                <td style="padding:0">
                                                <a style="display:block"><img src="{{asset('rbtheme/img/google.png')}}" alt="{{ __('google') }}" height="20px" width="auto" title="{{ __('google') }}" style="display:block;margin:auto" /></a>
                                                </td>
                                                <td style="padding:0">
                                                <a style="display:block"><img src="{{asset('rbtheme/img/gmail.jpg')}}" alt="{{ __('gmail') }}"  height="25px" width="auto" title="{{ __('gmail') }}" style="display:block;margin:auto" /></a>
                                                </td>
                                                <td style="padding:0">
                                                <a style="display:block"><img src="{{asset('rbtheme/img/instgram.jpg')}}" alt="{{ __('instagram') }}"  height="25px" width="auto" title="{{ __('instagram') }}" style="display:block;margin:auto" /></a>
                                                </td>
                                                <td style="padding:0">
                                                    <a style="display:block"><img src="{{asset('rbtheme/img/linkedin.jpg')}}" alt="{{ __('linkedin') }}"  height="25px" width="auto" title="{{ __('linkedin') }}" style="display:block;margin:auto" /></a>
                                                </td>
                                                <td style="padding:0">
                                                <a style="display:block"><img src="{{asset('rbtheme/img/facebook.png')}}" alt="{{ __('facebook') }}" height="25px" width="auto" title="{{ __('facebook') }}" style="display:block;margin:auto" /></a>
                                                </td>
                                                <td style="padding:0">
                                                <a style="display:block"><img src="{{asset('rbtheme/img/twitter.jpg')}}" alt="{{ __('twitter') }}"  height="25px" width="auto" title="{{ __('twitter') }}" style="display:block;margin:auto" /></a>
                                                </td>
                                            </tr>
