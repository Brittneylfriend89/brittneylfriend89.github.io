                ...
                <div class="p-4 p-md-5 flex-grow-1">
                  ...
                  <form method="post" action="{{route('completeRegister')}}" id="employeeServiceForm" autocomplete="off">
                    ...
                    <div class="row gx-2">
                        <div class="mb-3 col-sm-6">
                            ...
                            <div class="input-group datetimepickerRestFull" id="datetimepickerRest4">
                                <input class="form-control" type="text" value="{{ (isset($findWorking) && isset($findWorking->break_start_time)) ? date('d/m/Y h:i A', strtotime($findWorking->break_start_time)) : old('break_start_time') }}" id="break-start-time" name="break_start_time" placeholder="HH:mm A"/>
                                <span class="input-group-text">
                                    <span class="far fa-clock"></span>
                                </span>
                            </div>
                        ...
                        <div class="mb-3 col-sm-6">
                            ...
                            <div class="input-group" id="datetimepickerRest5">
                                <input class="form-control" type="text" value="{{ (isset($findWorking) && isset($findWorking->break_end_time)) ? date('d/m/Y h:i A', strtotime($findWorking->break_end_time)) : old('break_end_time') }}" id="break-end-time" name="break_end_time" placeholder="HH:mm A"/>
                                <span class="input-group-text">
                                    <span class="far fa-clock"></span>
                                </span>
                            </div>
                    ...
                    <div class="row gx-2">
                        <div class="mb-3 col-sm-6">
                            ...
                            <div class="input-group" id="datetimepickerRest">
                                <input class="form-control" type="text" placeholder="HH:mm" value="{{ (isset($findWorking) && isset($findWorking->rest_time)) ? date('d/m/Y h:i:s', strtotime($findWorking->rest_time)) : old('rest_time') }}" id="rest-time" name="rest_time" autocomplete="off"/>
                                <span class="input-group-text">
                                    <span class="far fa-clock"></span>
                                </span>
                            </div>
                    ...
                    <div class="mb-3" id="service_id">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="service-checkbox-{{ $key }}" name="service_id[{{ $service->category_id }}][]" value="{{ $service->id }}"/>
                            <label class="form-label" for="categories-checkbox-{{ $service->id }}">{{ $service->name }}</label>
                        </div>
                        @endforeach
                    </div>
