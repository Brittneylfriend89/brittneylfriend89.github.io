<div  class="modal fade" id="registerModel" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="registerLabel" aria-hidden="true">
          ...
          <form action="{{ route('register') }}" method="post" id="sign-up-form" autocomplete="off">
            ...
            <div class="row gx-2">
                ...
                <div class="mb-3 col-sm-6">
                  ...
                  <label id="valid-msg" style="color: green;" class="d-none phone-valid-msg">Phone Number Valid</label>
