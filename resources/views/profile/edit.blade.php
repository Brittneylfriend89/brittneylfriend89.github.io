                        ...
                        <div class="col-md-3 pt-0">
                            <form method="POST" id="profile-form" action="{{ route('users.update',Auth::user()->id) }}" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <span class="z-index-1 text-white dark__text-white text-center fs--1">
                                    ...
                                    <button  class="btn btn-danger" data-bs-title="Remove" title="Remove Profile Picture"><i class="fa fa-trash"></i></button>
                                </span>
                            </form>
                            ...
                            <ul class="nav nav-tabs list-group list-group-flush account-settings-links curser-set mt-3" role="tablist">
                                ...
                                <li class="nav-item list-group-item-action">
                                    @if(isset($employee->google_verify) && $employee->google_verify == true)
                                        <span class="list-group-item">Google Calendar: <b>Connected</b></span>
                                    @endif
                                </li>
                                <li class="nav-item list-group-item-action">
                                    @if(isset($employee->google_verify) && $employee->google_verify == true)    
                                    {{ Form::open(['method' => 'DELETE','id' => 'removeItem','route' => ['removegoogle',$employee->id]]) }}
                                        <span class="list-group-item remove-google-access btn-disconnect" style="background-color: #dc3545;color:#fff;font-size: 17px;">Disconnect Google Calendar</span>
                                    {{ Form::close() }}
                                    @else
