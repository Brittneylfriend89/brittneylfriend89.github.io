            ...
            <div class="card mb-2">
                ...
                <div class="card-body position-relative">
                    ...
                    <div><strong class="me-2">{{ __('Status') }}: </strong>
                        ...
                        <div class="badge bg-danger fs--2"><span class="fa fa-check ms-1"
                                data-fa-transform="shrink-2"></span> {{ ucfirst($appointment->status) }}</div>
                        @endif
                        ...
                        <table class="table table-striped border-bottom">
                            ...
                            <tbody>
                                <tr class="border-200">
                                    ...
                                    <td class="align-middle">
                                        <h4 class="text-end">{{ date('h:i a',strtotime($appointment->finish_time)) }}
                                        </h4>
                                    </td>
                                    <td class="align-middle">
                                        <h4 class="text-end">{{ date($custom->date_format,strtotime($appointment->date)) }}</h4>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
