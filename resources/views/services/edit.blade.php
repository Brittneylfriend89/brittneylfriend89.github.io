                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <div class='input-group' id="datetimepickerRest">
                                                    <input type='text' class="form-control custom-control @error('duration') is-invalid @enderror timeDuration" name="duration" value="{{ date('Y-m-d H:i', strtotime($service->duration)) }}" autocomplete="off">
                                                    <span class="input-group-text">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <div class='input-group' id="datetimepickerRest1">
                                                    <input type='text' class="form-control custom-control time @error('cancel_before') is-invalid @enderror timeDuration" name="cancel_before" value="{{ date('Y-m-d H:i', strtotime($service->cancel_before)) }}"  autocomplete="off">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="file" class="form-control" id="service_image" name="image" value="{{ $service->image }}">
                                                @error('image')
                                                        <span class="error-message">{{ $message }}</span>
                                                @enderror
