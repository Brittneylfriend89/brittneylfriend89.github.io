                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <div class='input-group' id="datetimepickerRest">
                                                    <input type='text' class="form-control time @error('duration') is-invalid @enderror timeDuration" name="duration" id="duration" placeholder="{{ __('Duration')}}" autocomplete="off"/>
                                                    <span class="input-group-text">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <div class='input-group' id="datetimepickerRest1">
                                                    <input type='text' class="form-control time @error('cancel_before') is-invalid @enderror timeDuration" placeholder="{{ __('Cancel Appointment') }}" name="cancel_before" />
                                                    <span class="input-group-text">
                                                        <span class="glyphicon glyphicon-time"></span>
                                                    </span>
                                                </div>
